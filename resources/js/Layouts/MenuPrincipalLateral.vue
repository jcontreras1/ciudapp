...
<template>
    ...
    <div class="nav d-flex justify-content-around d-md-inline">
        ...
        <NavLink v-if="$page.props.auth.user" :href="'/ask'" icon='<svg xmlns="http://www.w3.org/2000/svg" width="19" fill="currentColor" viewBox="0 0 512 512" id="icons" class="">
